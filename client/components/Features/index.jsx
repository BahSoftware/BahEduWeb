          ...
          <div className="">
            <div className="lg:max-w-lg">
              <p className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Online Eğitim Platformunda Neler Var?
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Bu platform Büyük Anadolu Hastaneleri çalışanlarının kişisel ve
                kariyer gelişimini güçlendirmek için Büyük Anadolu Hastanesi
                yazılım ekibi tarafından geliştirilmiştir.
              </p>
              <dl className="mt-6 max-w-xl space-y-4 text-base leading-7 text-gray-600 lg:max-w-none">
                <div className="relative pl-9">
                  ...
                  <dd className="inline">
                    Sertifikalı ve kişiye özel eğitimler!
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    Geniş eğitim havuzu ile yüzlerce kategoride eğitim!
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    Güncel teknolojilerle geliştirilmiş hızlı altyapı!
                  </dd>
                </div>
              </dl>
            </div>
          ...
          <div className="flex w-1/2 items-center">
            {isClient && (
              <ReactPlayer
                playing={true}
                loop={true}
                url="https://www.youtube.com/watch?v=PVTC0vL6-yM"
                controls={true}
